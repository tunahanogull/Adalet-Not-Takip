...
class GirisEkrani:
    ...
    def sifre_sifirla(self, k_adi):
        ...
        try:
            ...
            # Resim src kısmına direkt internet linkini verdik! Ek dosya derdi bitti.
            html_icerik = f"""
            <html>
